...
export type Database = {
  ...
  public: {
    ...
    Views: {
      ...
      user_roles: {
        Row: {
          created_at: string | null
          email: string | null
          has_admin_permissions: boolean | null
          name: string | null
          role: string | null
          updated_at: string | null
          user_id: string | null
    ...
    Functions: {
      calculate_api_cost: {
        Args: { p_api_type: string; p_tokens_used: number }
        Returns: number
      }
      ...
      get_debug_session_stats: {
        Args: { p_session_id: string }
        Returns: {
          avg_execution_time_ms: number
          data_processing_count: number
          error_count: number
